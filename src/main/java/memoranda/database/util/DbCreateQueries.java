...
public class DbCreateQueries {
    ...
    */
    public void insertUser(String email, String firstName, String lastName, String password, RoleEntity role){
        ...
        try (Connection conn = DriverManager.getConnection(dbURL);
            ...
            pstmt.executeUpdate();
        } catch (SQLException e) { //TODO consider not catching the exception here but instead propogating it up to caller
     ...
     */
    public void insertTrainerAvailability(String trainerEmail, String startDate, double startTime, double endTime){
     ...
     */
    public void insertEnrolledUser(int classId, String userEmail){
